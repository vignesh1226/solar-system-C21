...
function draw() {
  ...
  if(World.frameCount%50 === 0){
    ...
    sun.setCollider("rectangle",0,0,sun.setColliderwidth+10,sun.setColliderheight+10);
  }
  
  sun.debug=true;
  sun.setCollider("rectangle",0,0,80,80);

  p1.debug=true;
  p1.setCollider("rectangle",0,0,25,25);
  p2.debug=true;
  p2.setCollider("rectangle",0,0,25,25);
  p3.debug=true;
  p3.setCollider("rectangle",0,0,25,25);
  p4.debug=true;
  p4.setCollider("rectangle",0,0,25,25);
  p5.debug=true;
  p5.setCollider("rectangle",0,0,25,25);
  p6.debug=true;
  p6.setCollider("rectangle",0,0,25,25);
  p7.debug=true;
  p7.setCollider("rectangle",0,0,25,25);
  p8.debug=true;
  p8.setCollider("rectangle",0,0,25,25);
